          ...
          <div className="record__container">
            <div className="record__data">
              ...
              <div className="record__total">
                <p className="Record__day">
                  <span className="Record__date">Ngày mượn: </span>
                  {formatDate(borrowDate)}
                </p>
                <p className="Record__day">
                  <span className="Record__date">Đến hạn: </span>
                  {formatDate(dueDate)}
                </p>
                <p>
                  <span className="Record__date">Tổng tiền: </span>
            ...
            <form className="record__form" onSubmit={handleSubmit}>
              ...
              <input
                ...
                required
              />
              <button type="submit" className="Record__button">
                Xác nhận
              </button>
            </form>
          </div>
